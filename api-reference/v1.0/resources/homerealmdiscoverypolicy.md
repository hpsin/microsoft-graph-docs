...
| [List appliesTo](../api/homerealmdiscoverypolicy-list-appliesto.md) | [directoryObject](directoryobject.md) collection | Get the list of directoryObjects that this [policy has been applied to](../api/serviceprincipal-post-homerealmdiscoverypolicies.md). |
